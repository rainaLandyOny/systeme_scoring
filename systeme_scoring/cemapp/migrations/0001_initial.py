# Generated by Django 5.1.3 on 2025-05-26 10:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('capitale_total', models.DecimalField(decimal_places=2, max_digits=12)),
            ],
        ),
        migrations.CreateModel(
            name='Client',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('directeur_agence', "Directeur de l' Agence"), ('analyste_demande', 'Analyste des Demandes'), ('gestionnaire', 'Gestionnaire des Demandes'), ('service_client', 'Service Client'), ('agent_inspection', "Agent d' Inspection")], default='service_client', max_length=25)),
